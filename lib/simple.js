...
END:VCARD
    ...
    async value (jid, buffer, contentText, footerText, button1, id1, quoted, options) {
            ...
            return await conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: 9999999999, contextInfo: { mentionedJid: conn.parseMention(contentText + footerText) }, ...options })
        }
    },
    send2ButtonImg: {
